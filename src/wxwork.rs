...
mod tests {
    ...
    fn decryption_works() {
        ...
        let token = "QDG6eK";
        let enc_aes_key = "jWmYm7qr5nMoAUwZRjGtBxmz3KA1tkAj3ykkR6q2B2C";

        let wxw = WxWork::new(corp_id, token, enc_aes_key).expect("should be a WxWork object");
        ...
        let s = wxw
            .decrypt(timestamp, nonce, signature, msg_encrypt)
            .expect("decrypt thing should be a string result");
        assert_eq!(s, "<xml><ToUserName><![CDATA[wx5823bf96d3bd56c7]]></ToUserName>\n<FromUserName><![CDATA[mycreate]]></FromUserName>\n<CreateTime>1409659813</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[hello]]></Content>\n<MsgId>4561255354251345929</MsgId>\n<AgentID>218</AgentID>\n</xml>");
    }
}
